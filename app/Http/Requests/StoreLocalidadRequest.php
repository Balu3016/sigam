...
class StoreLocalidadRequest extends FormRequest
{
    ...
    {
        return true; // Se gestionará con Spatie Permission en fases posteriores
    }
    ...
    public function rules(): array
    {
        return [
            'nombre' => [
                ...
                'string',
                'max:150',
                Rule::unique('localidades', 'nombre'),
            ],
            'tipo' => [
                'required',
                'string',
    ...
    public function messages(): array
    {
        return [
            ...
            'nombre.unique' => 'Ya existe una localidad registrada con este nombre.',
